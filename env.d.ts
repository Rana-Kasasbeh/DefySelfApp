// env.d.ts
declare module '@env' {
  export const EXPO_PUBLIC_BREVO_API_KEY: string;
  export const EXPO_PUBLIC_SENDER_EMAIL: string;
  export const EXPO_PUBLIC_SENDER_NAME: string;
  ...
  export const EXPO_PUBLIC_FIREBASE_DATABASE_URL: string;
}